...
namespace tests
{
    ...
    class Test2 : TestCocosNodeDemo
    {
        public override void onEnter()
        {
            ...
            sp1.position = (ccMacros.CCPointMake(100, s.height / 2));
            sp2.position = (ccMacros.CCPointMake(380, s.height / 2));
            addChild(sp1);
            addChild(sp2);
            ...
            sp2.anchorPoint = (ccMacros.CCPointMake(0, 0));
    ...
    class Test4 : TestCocosNodeDemo
    {
        public Test4()
        {
            ...
            sp1.position = (ccMacros.CCPointMake(100, 160));
            sp2.position = (ccMacros.CCPointMake(380, 160));
