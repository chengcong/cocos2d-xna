...
namespace cocos2d
{
	public class CCTransitionZoomFlipAngular : CCTransitionSceneOriented
	{
		...
		public static new CCTransitionZoomFlipAngular transitionWithDuration(float t, CCScene s, tOrientation o)
		{
			CCTransitionZoomFlipAngular cCTransitionZoomFlipAngular = new CCTransitionZoomFlipAngular();
			cCTransitionZoomFlipAngular.initWithDuration(t, s, o);
