...
namespace cocos2d
{
	public class CCTransitionZoomFlipX : CCTransitionSceneOriented
	{
		...
		public override void onEnter()
		{
			...
			CCFiniteTimeAction[] cCFiniteTimeActionArray1 = new CCFiniteTimeAction[] { CCOrbitCamera.actionWithDuration(this.m_fDuration / 2f, 1f, 0f, single1, single, 0f, 0f), CCScaleTo.actionWithDuration(this.m_fDuration / 2f, 1f), CCShow.action() };
			...
			CCFiniteTimeAction[] cCFiniteTimeActionArray3 = new CCFiniteTimeAction[] { CCOrbitCamera.actionWithDuration(this.m_fDuration / 2f, 1f, 0f, single3, single2, 0f, 0f), CCScaleTo.actionWithDuration(this.m_fDuration / 2f, 0.5f) };
		...
		public static new CCTransitionZoomFlipX transitionWithDuration(float t, CCScene s, tOrientation o)
		{
			CCTransitionZoomFlipX cCTransitionZoomFlipX = new CCTransitionZoomFlipX();
			cCTransitionZoomFlipX.initWithDuration(t, s, o);
